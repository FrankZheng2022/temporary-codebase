...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='/fs/cml-projects/taco_rl/offline_data_libero')
    parser.add_argument('--libero_path', type=str, default='/fs/cml-projects/taco_rl/LIBERO/libero/datasets/libero_90')
